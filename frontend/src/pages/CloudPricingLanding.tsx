...
import { Calculator, BarChart2, Clock, Battery, Lock } from 'lucide-react';
...
export const CloudPricingLanding: React.FC = () => {
  ...
  const handleLaunch = () => {
    setActiveTab('cloud-tool');
    navigate('/?tab=cloud-tool');
  };
  ...
  const features = [
    ...
    },
    {
      ...
      desc: 'Chart quality vs cost metrics across all major open-source LLMs.',
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-16 py-8">
      <Helmet>
        <title>Cloud Pricing | GPURunner</title>
